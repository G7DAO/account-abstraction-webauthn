...
parsedCredentialPublicKey, authResponse) => {
    const authDataBuffer = base64url.toBuffer(authResponse.authenticatorData);
    const clientDataHash = Buffer.from(ethers.utils.sha256(base64url.toBuffer(authResponse.clientDataJSON)).slice(2), 'hex');
...
//# sourceMappingURL=authResponseToSigVerificationInput.js.map