...
class Barz extends builder_1.UserOperationBuilder {
    constructor(signer, rpcUrl, opts) {
        ...
        this.factory = typechain_1.BarzFactory__factory.connect((opts === null || opts === void 0 ? void 0 : opts.factory) || constants_1.Barz.Factory, this.provider);
        this.initCode = "0x";
        this.proxy = typechain_1.BarzAccountFacet__factory.connect(ethers_1.ethers.constants.AddressZero, this.provider);
    }
            ...
            try {
                instance.initCode = yield ethers_1.ethers.utils.hexConcat([
                    ...
                    instance.factory.interface.encodeFunctionData("createAccount", [
                        constants_1.Barz.Secp256r1VerificationFacet,
                        yield instance.signer.getPublicKey(),
                        ethers_1.ethers.BigNumber.from((_a = opts === null || opts === void 0 ? void 0 : opts.salt) !== null && _a !== void 0 ? _a : 0),
                    ]),
                ]);
                ...
                if (!addr)
                    throw error;
                instance.proxy = typechain_1.BarzAccountFacet__factory.connect(addr, instance.provider);
            }
            const base = instance
                .useDefaults({
