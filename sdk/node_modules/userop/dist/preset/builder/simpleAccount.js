...
class SimpleAccount extends builder_1.UserOperationBuilder {
    constructor(signer, rpcUrl, opts) {
        ...
        this.resolveAccount = (ctx) => __awaiter(this, void 0, void 0, function* () {
            const [nonce, code] = yield Promise.all([
        ...
        this.initCode = "0x";
        this.nonceKey = (opts === null || opts === void 0 ? void 0 : opts.nonceKey) || 0;
    ...
    static init(signer, rpcUrl, opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const base = instance
                ...
                signature: yield ethers_1.ethers.Wallet.createRandom().signMessage(ethers_1.ethers.utils.arrayify(ethers_1.ethers.utils.keccak256("0xdead"))),
            })
