...
import {GasLessUserOperation, GasLessUserOperationLib} from "./lib/GasLessUserOperation.sol";
...
contract Paymaster is BasePaymaster {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        require(
            paymasterAndData.signature.length == 64 ||
        ...
        address recoveredAddress = GasLessUserOperationHash
            .toEthSignedMessageHash()
            .recover(paymasterAndData.signature);

        console2.log("owner()", owner());
        console2.log("recoveredAddress", recoveredAddress);
