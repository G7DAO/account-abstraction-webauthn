...
export interface TestOpcodesAccountInterface extends utils.Interface {
  functions: {
    "addStake(address)": FunctionFragment;
    "execEvent()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "execEvent", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "execEvent", data: BytesLike): Result;
  ...
  events: {
    "ExecutionMessage()": EventFragment;
    "State(uint256,uint256)": EventFragment;
    "TestMessage(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "ExecutionMessage"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "State"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TestMessage"): EventFragment;
}

export interface ExecutionMessageEventObject {}
export type ExecutionMessageEvent = TypedEvent<[], ExecutionMessageEventObject>;

export type ExecutionMessageEventFilter =
  TypedEventFilter<ExecutionMessageEvent>;
...
export type TestMessageEvent = TypedEvent<[string], TestMessageEventObject>;

export type TestMessageEventFilter = TypedEventFilter<TestMessageEvent>;

export interface TestOpcodesAccount extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestOpcodesAccountInterface;
  ...
  callStatic: {
    ...
    execEvent(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    "ExecutionMessage()"(): ExecutionMessageEventFilter;
    ExecutionMessage(): ExecutionMessageEventFilter;
    ...
    "TestMessage(address)"(eventSender?: null): TestMessageEventFilter;
    TestMessage(eventSender?: null): TestMessageEventFilter;
  };
